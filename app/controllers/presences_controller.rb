class PresencesController < ApplicationController
  ...
  def new
    ...
    @employee = Employee.where(:employee_id => @employee)
  end
  ...
  def create
    ...
    respond_to do |format|
      if @presence.save
        format.html { redirect_to  @presence.employee, notice: 'Presence was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @presence.update(presence_params)
        format.html { redirect_to @presence.employee, notice: 'Presence was successfully updated.' }
  ...
  def destroy
    @presence.destroy
    respond_to do |format|
      format.html { redirect_to @presence.employee, notice: 'Presence was successfully destroyed.' }
