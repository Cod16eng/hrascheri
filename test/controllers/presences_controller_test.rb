...
class PresencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create presence" do
    assert_difference('Presence.count') do
      post presences_url, params: { presence: { date: @presence.date, employee_id: @presence.employee_id, hour: @presence.hour } }
    end
  ...
  test "should update presence" do
    patch presence_url(@presence), params: { presence: { date: @presence.date, employee_id: @presence.employee_id, hour: @presence.hour } }
